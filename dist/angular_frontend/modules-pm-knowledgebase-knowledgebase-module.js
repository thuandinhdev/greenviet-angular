...
var CreateArticalModalComponent = /** @class */ (function () {
    function CreateArticalModalComponent(translate, formBuilder, bsCreateArticalModalRef, toastr, knowledgeBaseService) {
        ...
        this.categories = [];
        this.editorConfig = _core_helpers_admin_helper__WEBPACK_IMPORTED_MODULE_8__["editorConfig"];
    }
...
var EditArticleModalComponent = /** @class */ (function () {
    ...
    EditArticleModalComponent.prototype.loadDropzone = function () {
        var that = this;
        this.logoDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_10__(this.logodropzone.nativeElement, {
            url: 'https://httpbin.org/post',
            maxFiles: 1,
            clickable: true,
            acceptedFiles: 'image/*',
            ...
            init: function () {
                this.on('addedfile', function (file) {
                    var removeButton = dropzone__WEBPACK_IMPORTED_MODULE_10__["createElement"]('<button class=\'btn btn-sm btn-block\'>Remove file</button>');
                    var _this = this;
                    removeButton.addEventListener('click', function (e) {
                        e.preventDefault();
                        e.stopPropagation();
