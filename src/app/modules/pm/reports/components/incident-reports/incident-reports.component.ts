...
export class IncidentReportsComponent implements OnInit {
	...
	loadDatatable() {
		...
		this.dtOptions = {
			...
			ajax: (dataTablesParameters: any, callback) => {
				this.http
					.post<DatatablesResponse>(this.apiUrl + '/api/incident/incident-report', dataTablesParameters, {})
					.subscribe(resp => {
	...
	exportFiles(type) {
		...
		this.exportAsService.save(this.exportAsConfig, this.translate.instant('reports.headings.incident_report')).subscribe(() => {});
	}
