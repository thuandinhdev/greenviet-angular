...
export class InvoiceCreateComponent implements OnInit {
	...
	get invoiceControl() { return this.createInvoiceForm.controls; }

	get itemControl() {   return this.createInvoiceForm.get('item'); }
	...
	changeRecurrence($event = []) {
		if (this.createInvoiceForm.value.recurrence) {
			this.createInvoiceForm.get('recurrence_occurrences').setValidators([Validators.required]);
			this.createInvoiceForm.get('recurrence_pattern').setValidators([Validators.required]);
